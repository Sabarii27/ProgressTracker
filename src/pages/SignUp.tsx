    ...
    <div style={{ minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", background: "#f7fafc" }}>
      <form onSubmit={handleSubmit} style={{ width: 350, padding: 32, borderRadius: 16, boxShadow: "0 2px 16px #0001", background: "#fff", display: "flex", flexDirection: "column", gap: 18 }}>
        <div style={{ textAlign: "center", marginBottom: 12 }}>
          ...
          <h2 style={{ fontSize: 28, margin: "12px 0 0 0" }}>Sign Up</h2>
          <p style={{ color: "#888", fontSize: 16 }}>Create your account to get started.</p>
        </div>
        <input
          type="email"
          placeholder="Email"
        ...
        <button type="button" style={{ background: "none", border: "none", color: "#3182ce", cursor: "pointer", fontSize: 16, marginTop: 4 }} onClick={() => navigate("/signin")}>Already have an account? Sign In</button>
